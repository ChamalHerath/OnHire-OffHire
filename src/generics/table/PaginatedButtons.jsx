...
import { Button, ButtonGroup, TextField } from '@mui/material';//Inputs
import { NavigateNext, NavigateBefore, SkipNext, SkipPrevious } from '@mui/icons-material';//Icons
...
export class PaginatedButtons extends Component {
    ...
    createControls() {
        ...
        let controls = [];
        let length = (this.props.rows == null ? 0 : this.props.rows.length);//Amount of data
        const pageCount = (length > this.props.pageSize) ? Math.ceil(length / this.props.pageSize) : 1;//Is there enough data to overflow the page? If not then pageCount is 1
